...
solution = "FSVMPORTS.txt"  # Path to your file (make sure it points to a valid JSON file)
...
try:
    ...
    print("File data:", file_data)  # Print the raw data for debugging
...
####################################################################################################
Source_Ip = '172.16.0.5'  # FD
port = 22  # FD
Source_name = 'nutanix'  # FD
Source_password = 'Api@0509'  # FD

Destinationip = '172.16.0.224'  # FD
